...
publico INTEGER,
constraint fk_idpais_1 foreign key (pais_idpais_1) references pais(idpais),
constraint fk_idpais_2 foreign key (pais_idpais_2) references pais(idpais),
constraint fk_idestadio foreign key (estadio_idestadio) references estadio(idestadio)
);
...
amarelo BOOLEAN,
tempo VARCHAR(25),
constraint fk_idrodada foreign key (jogador_idjogador) references jogador(idjogador)
);
...
jogador_idjogador INTEGER,
tempo VARCHAR(25),
constraint fk_idjogador foreign key (jogador_idjogador) references jogador(idjogador)
);
...
tempo VARCHAR(25),
constraint fk_idjogador_1 foreign key (jogador_idjogador_sai) references jogador(idjogador),
constraint fk_idjogador_2 foreign key (jogador_idjogador_entra) references jogador(idjogador)
);
...
constraint fk_idpais_1  foreign key (pais_idpais) references pais(idpais)
);
use copa_mundo;
